...
/**
 * 在BottomSheetBehavior的基础上扩展支持上下左右四个方向
 */
public class AllSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    /**
     ...
     */
    public AllSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.SheetBehavior);
        setPeekHeight(a.getDimensionPixelSize(
                R.styleable.SheetBehavior_sheet_behavior_peekHeight, 0));
        setHideable(a.getBoolean(R.styleable.SheetBehavior_sheet_behavior_hiddenEnable, false));
        mSlideModel = a.getInt(R.styleable.SheetBehavior_sheet_behavior_slideMode, BOTTOM_SHEET);
        a.recycle();
...
//            }
    ...
    /**
     * A utility function to get the {@link AllSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link AllSheetBehavior}.
     * @return The {@link AllSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> AllSheetBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof AllSheetBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehavior");
        }
        return (AllSheetBehavior<V>) behavior;
    }
